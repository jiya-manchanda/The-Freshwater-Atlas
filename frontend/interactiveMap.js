    ...
    const infoWindow = new google.maps.InfoWindow({
      content: `
        <div style="font-family: Arial, sans-serif; font-size: 14px; max-width: 250px;">
          ...
          <img src="https://via.placeholder.com/150" alt="${resource.name}" 
            style="width: 100%; border-radius: 5px; margin: 5px 0;">
          <a href="#" style="text-decoration: none; color: #2E86C1;">Learn more</a>
        </div> `,
    });
